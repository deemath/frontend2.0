...
class TokenManagerService {
  ...
  Future<void> initialize() async {
    try {
      ...
      print('TokenManagerService: Initialization complete, hasToken: ${hasToken}');
    } catch (e) {
  ...
  Future<bool> refreshToken() async {
    try {
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        print('Unexpected refresh response format or status code: ${response.statusCode}');
      }
      ...
      if (e is DioException) {
        print('DioException details - Status code: ${e.response?.statusCode}, Message: ${e.message}');
